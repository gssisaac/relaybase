...
import { BroadcastComposeForm } from "@/scale/pages/campaigns/BroadcastComposeForm";
...
import { scaleApi, type BroadcastStatus, type ScaleAccountCompliance } from "@/lib/scale/api";
import {
...
export function BroadcastContentView() {
  ...
  async function handleDuplicate() {
    setDuplicating(true);
    try {
      const duplicate = await scaleApi.duplicateBroadcast(broadcastId);
