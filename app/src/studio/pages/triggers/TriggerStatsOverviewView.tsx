...
import { StudioOverviewTriggersChart } from "@/studio/pages/overview/StudioOverviewCharts";
...
export function TriggerStatsOverviewView() {
  ...
  const load = useCallback(async (force?: boolean) => {
    ...
    try {
      setData(await studioApi.getTriggerStatsOverview());
    } catch {
            ...
            <>
              ...
              <Card size="sm">
                ...
                <CardContent className="pt-0">
                  <StudioOverviewTriggersChart data={data.byDay ?? []} />
                </CardContent>
              </Card>
