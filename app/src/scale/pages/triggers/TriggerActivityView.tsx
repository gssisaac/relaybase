...
import { scaleApi, type TriggerSend, type TriggerEvent } from "@/lib/scale/api";
...
export function TriggerActivitySections({ triggerId }: { triggerId: string }) {
  const [events, setEvents] = useState<TriggerEvent[]>([]);
  const [sends, setSends] = useState<TriggerSend[]>([]);
