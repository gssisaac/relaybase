...
export function refreshNewsletterAudienceLink(
  broadcastId: string,
  groupId: string,
...
export function syncAllNewslettersForAudienceGroup(_groupId: string): void {
  /* no-op: newsletters read audience from the group at send time */
}
