...
export const scaleComplianceIdentities = new Hono();

// GET /scale/compliance-identities
scaleComplianceIdentities.get("/", (c) => {
...
// POST /scale/compliance-identities { name?, organizationName?, postalAddress?, contactEmail?, setAsDefault? }
scaleComplianceIdentities.post("/", async (c) => {
  let body: {
    name?: string;
...
// PATCH /scale/compliance-identities/:id
scaleComplianceIdentities.patch("/:id", async (c) => {
