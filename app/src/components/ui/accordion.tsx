    ...
    <AccordionPrimitive.Header className="flex">
      ...
      >
        ...
        <ChevronDown
          ...
          className="pointer-events-none size-3 group-aria-expanded/accordion-trigger:hidden"
        />
        <ChevronUp
          data-slot="accordion-trigger-icon"
          className="pointer-events-none hidden size-3 group-aria-expanded/accordion-trigger:inline"
        />
      </AccordionPrimitive.Trigger>
