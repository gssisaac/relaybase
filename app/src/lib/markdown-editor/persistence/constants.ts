...
export const OUTBOX_DB_NAME = "relaybase-crm-editor-persistence";
...
export const EMERGENCY_DRAFTS_KEY = "relaybase-crm:campaign-drafts";
...
export const OUTBOX_DRAIN_FLAG_KEY = "relaybase-crm:outbox-drain";
