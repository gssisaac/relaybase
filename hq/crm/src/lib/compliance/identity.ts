...
import type { AccountComplianceSettings, ComplianceIdentity, CrmDataStore } from "../../db/types";
...
export function accountDefaultComplianceIdentityId(data: CrmDataStore): string | null {
...
export function syncAccountComplianceMirror(draft: CrmDataStore): void {
...
export function ensureComplianceIdentitiesFromLegacy(draft: CrmDataStore, now: string): void {
