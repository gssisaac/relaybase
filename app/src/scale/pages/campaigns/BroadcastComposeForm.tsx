...
import { BroadcastComposeSidebar } from "@/scale/pages/campaigns/BroadcastComposeSidebar";
...
import type { ScaleAccountCompliance, ScaleTemplate } from "@/lib/scale/api";
...
export function BroadcastComposeForm({
  ...
  /** Broadcast id — asset upload namespace (`/scale/broadcasts/:id/assets`). */
  broadcastId: string;
