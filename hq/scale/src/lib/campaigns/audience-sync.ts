...
export function refreshCampaignAudienceLink(
  broadcastId: string,
  groupId: string,
...
export function syncAllCampaignsForAudienceGroup(_groupId: string): void {
  /* no-op: campaigns read audience from the group at send time */
}
