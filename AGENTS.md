...
| Desktop owner/invited unlock, Touch ID on launch, `AppSessionStore` phase machine, team keyring (`team-session`), or 401 re-prompt | [docs/desktop-session-machine.md](docs/desktop-session-machine.md) — launch Touch ID still broken: [docs/desktop-unlock-unresolved.md](docs/desktop-unlock-unresolved.md) |
