...
import { triggerContentEditHref, triggerDetailHref } from "@/scale/lib/paths";
import { TriggerContentView } from "@/scale/pages/triggers/TriggerContentView";
        ...
        <DesktopTitleBar className="px-4 py-3">
          <div className="flex min-w-0 items-center gap-3">
            <Button
              ...
              nativeButton={false}
              aria-label="Back"
              render={<Link href="/scale/triggers" />}
            >
