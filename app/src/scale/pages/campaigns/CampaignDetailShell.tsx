...
import { campaignDetailNavTabs } from "@/scale/lib/campaigns/campaign-detail-nav";
...
export function CampaignDetailShell({
  ...
  const title =
    ...
    (notFound ? "Campaign not found" : "Untitled campaign");

  const navOrder = campaignDetailNavTabs(campaign?.status);
