...
- Install / BYO Worker: [`../decisions/pivot-byo-cloudflare.md`](../decisions/pivot-byo-cloudflare.md)
- Storage map: [`../architecture/storage-architecture.md`](../architecture/storage-architecture.md)
- R2 mailbox layout: [`../architecture/mailbox-r2.md`](../architecture/mailbox-r2.md)
- Mail index (list + search): [`../architecture/mailbox-d1.md`](../architecture/mailbox-d1.md)
- Threading / multi-account: [`../features/inbox-threading.md`](../features/inbox-threading.md)
