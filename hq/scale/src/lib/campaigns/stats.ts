import type { CampaignStats, Recipient, TrackingEvent } from "../../db/types";
...
export function normalizeCampaignStats(raw: Partial<CampaignStats> | undefined): CampaignStats {
...
export function rollupCampaignStatsFromRecipients(
