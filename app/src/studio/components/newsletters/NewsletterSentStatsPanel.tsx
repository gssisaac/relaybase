        ...
        <>
          ...
          {data.byWeek.length > 0 ? (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Sent attempts, unique opens, and unique clicks by week.
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          {data.bySubscriberGroup.length > 0 ? (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Contribution of each linked group across finished sends.
                </CardDescription>
              </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Finished sends, newest first. Open a row for per-newsletter stats.
              </CardDescription>
            </CardHeader>
            <CardContent className="divide-y divide-border p-0">
