...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Backdrop
      ...
      className={cn(
        "fixed inset-0 isolate z-50 bg-black/15 backdrop-blur-[1px] duration-300 data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0",
        className,
      )}
      {...props}
    />
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        data-side={side}
        className={cn(
          "fixed z-50 flex flex-col gap-4 bg-popover bg-clip-padding text-sm text-popover-foreground shadow-lg transition ease-in-out data-open:animate-in data-closed:animate-out data-open:duration-500 data-closed:duration-300",
          side === "right" &&
