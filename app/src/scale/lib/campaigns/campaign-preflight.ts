import { missingRequiredTemplateVariables } from "@/scale/lib/layouts/layout-template-variables";
import { prepareLayoutTemplateHtml } from "@/scale/lib/layouts/layout-standard-footer";
import type { ScaleAccountCompliance, TemplateVariablesSchema } from "@/lib/scale/api";
...
export function runCampaignPreflight(input: {
  subject: string;
  bodyMarkdown: string;
  templateHtml: string;
  ...
  compliance: ScaleAccountCompliance | null | undefined;
}): PreflightCheck[] {
