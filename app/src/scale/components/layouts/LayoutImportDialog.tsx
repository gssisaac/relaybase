...
import { STANDARD_COMPLIANCE_FOOTER_HTML_APPEND } from "@/scale/lib/layouts/layout-standard-footer";
...
export function LayoutImportDialog({
  ...
  async function submit() {
    ...
    setError(null);
    try {
      const { layout, warnings } = await scaleApi.importLayout({
        name: trimmedName,
        htmlSource,
      ...
      setError(e instanceof ScaleApiError ? e.message : "Import failed");
      setSaving(false);
    }
  }
