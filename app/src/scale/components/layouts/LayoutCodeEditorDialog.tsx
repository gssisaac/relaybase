...
export function LayoutCodeEditorDialog({
  ...
  template: ScaleLayout | null;
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onSaved?: (result: { template: ScaleLayout; forked: boolean }) => void;
}) {
  ...
  async function submit() {
    ...
    setError(null);
    try {
      const { layout: saved, forked, warnings } = await scaleApi.saveLayoutSource(template.id, {
        htmlSource,
