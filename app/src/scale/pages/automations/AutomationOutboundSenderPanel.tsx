...
import { resolveAutomationSendingDomain } from "@/scale/lib/automation-sending-domain";
...
export function AutomationOutboundSenderPanel({
  draft,
  onDraftChange,
  disabled,
}: {
  ...
  async function saveSender() {
    ...
    const sendDomain = resolveAutomationSendingDomain(automation, fromEmail);
    if (!sendDomain) {
