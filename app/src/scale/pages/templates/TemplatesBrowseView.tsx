...
} from "@/scale/lib/template-paths";
import { TemplateBrowseSidebarEmpty } from "@/scale/pages/templates/TemplateDetailSidebar";
import {
  TemplateDetailProvider,
  useTemplateDetail,
} from "@/scale/pages/templates/TemplateDetailContext";
import { TemplatePreviewShell } from "@/scale/pages/templates/TemplatePreviewShell";
import { TemplatePreviewView } from "@/scale/pages/templates/TemplatePreviewView";
import { TemplateSidebarNewProvider } from "@/scale/pages/templates/TemplateSidebarNewContext";
