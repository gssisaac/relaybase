...
import {
  AutomationOutboundSenderPanel,
  type OutboundSenderDraft,
} from "@/scale/pages/automations/AutomationOutboundSenderPanel";
...
export function AutomationPreviewView() {
  ...
  useEffect(() => {
    ...
    setSenderDraft({
      fromName: automation.fromName ?? null,
      fromEmail: automation.fromEmail ?? null,
  ...
  const previewFromEmail = senderDraft.fromEmail ?? automation.fromEmail ?? "you@example.com";
  const previewFromName = senderDraft.fromName ?? automation.fromName;
