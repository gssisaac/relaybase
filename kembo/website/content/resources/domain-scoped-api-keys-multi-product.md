...
See how this scales across a whole portfolio of products in [the multi-product email infrastructure guide](/resources/multi-product-email-infrastructure-guide), or how inbound mail flows through the same domain-scoped model in [inbound email webhooks for support tickets](/resources/inbound-email-webhooks-support-tickets). To issue your first domain-scoped key, [join the Relaybase beta](/get-started).
