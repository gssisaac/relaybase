...
import {
  ...
  formatInMinutes,
  formatWhen,
} from "@/scale/lib/campaigns/campaign-dispatch-display";
import type { CampaignDispatchProgress } from "@/lib/scale/api";

type Props = {
  dispatch: CampaignDispatchProgress;
  /** Optional action (e.g. link to stats) aligned to the right on wide screens. */
  action?: ReactNode;
  compact?: boolean;
};

export function CampaignSendingProgressPanel({ dispatch, action, compact }: Props) {
