...
import { CampaignTemplateVariablesEditor } from "@/scale/components/campaigns/CampaignTemplateVariablesEditor";
...
import { CampaignPreflightChecklist } from "@/scale/components/campaigns/CampaignPreflightChecklist";
...
import { runCampaignPreflight } from "@/scale/lib/campaigns/campaign-preflight";
...
export function CampaignComposeSidebar({
  campaignId,
  assetOwner = "campaign",
      ...
      <aside className="flex min-h-0 w-full shrink-0 flex-col overflow-hidden border-border lg:w-[280px] lg:border-l">
        ...
        <Tabs defaultValue="templates" className="flex min-h-0 flex-1 flex-col gap-0">
          ...
          <TabsContent value="variables" className="mt-0 min-h-0 flex-1 overflow-y-auto p-2">
            ...
            <CampaignTemplateVariablesEditor
