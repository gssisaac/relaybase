...
import { BroadcastTemplateVariablesEditor } from "@/scale/components/BroadcastTemplateVariablesEditor";
...
import { BroadcastPreflightChecklist } from "@/scale/components/BroadcastPreflightChecklist";
import { ScaleTemplateCodeEditorDialog } from "@/scale/components/ScaleTemplateCodeEditorDialog";
...
export function BroadcastComposeSidebar({
  ...
  const [codeEditorTemplate, setCodeEditorTemplate] = useState<ScaleTemplate | null>(null);
