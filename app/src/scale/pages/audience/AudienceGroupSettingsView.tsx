...
import { useDomainAddresses } from "@/scale/lib/use-domain-addresses";
...
import { AudienceDataSourceGuide } from "@/scale/pages/audience/AudienceDataSourceGuide";
import {
...
export function AudienceGroupSettingsView() {
  ...
  async function testConnection() {
    ...
    try {
      const data = await scaleAudienceApi.testConnection({
        endpointUrl,
        groupId,
  ...
  async function save() {
    ...
    try {
      ...
      await scaleAudienceApi.updateGroup(groupId, {
        name,
        domain: groupDomain,
        ...(workerUrl ? { workerUrl } : {}),
  ...
  async function confirmDelete() {
    ...
    setError(null);
    try {
      await scaleAudienceApi.deleteGroup(groupId);
      clearAudienceGroupDetailCache(productId, groupId);
