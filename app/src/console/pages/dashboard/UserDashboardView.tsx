...
import { ApiActivityChart } from "@/console/pages/dashboard/ApiActivityChart";
import { ConnectionStatusCards } from "@/console/pages/dashboard/ConnectionStatusCards";
import {
...
const KPI_CARDS = [
  ...
  },
  {
    ...
    label: "Broadcasts",
    description: "Scale broadcasts and audience",
    path: "broadcasts" as const,
  },
  {
    key: "audience" as const,
    label: "Audience",
    description: "Contact groups for Scale",
